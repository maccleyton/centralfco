...
(function () {
  ...
  function agencyAddress(data) {
    ...
    return `${escapeHtml(agency.endereco)} · ${escapeHtml(agency.bairro)} · ${escapeHtml(agency.municipio)}-${escapeHtml(agency.uf)} · CEP ${escapeHtml(agency.cep)}`;
  }
