...
(function () {
  ...
  function header(title, logo) {
    ...
    return `<header class="document-header${titleClass}"><img src="${logo}" alt="Banco do Brasil"><div><span>FCO EMPRESARIAL</span><strong>${escapeHtml(title)}</strong></div></header>`;
  }
